...
/* 子命令帮助文本（堆分配，调用�?free）�? * op∈{inject,clean,query,list}；uid 可为 NULL/空�? * inject/clean/query：枚�?registry 中支持该 op 的故障及其必�?可选参数；
 *   �?uid 命中某故障，优先详述该故障并给出参数示例�? * list：描述目录列出行为，无参数表�?*/
