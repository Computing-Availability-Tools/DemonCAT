...
CPU 5 / 存储 5 / 网络 13 / 进程 5 / 内存 4 / 文件系统 2 / Docker 2 / NPU 20 / 系统 2，按模块分布：
...
- 20 条 `rNPU_*` 故障全部通过真机 inject/clean/query 验证（device 2 & 5）
...
- NPU 20 条故障需 Atlas 物理机 + `hccn_tool` 真机验证（910B4 + 910C 已验证）
