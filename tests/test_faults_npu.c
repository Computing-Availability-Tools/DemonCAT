...
int main(void) {
    ...
    /* rNPU_link_down */
    {
        ...
        result_free(r);
        r = dispatch_route("rNPU_link_down", "clean", &p);
        CK(r && r->code == 0);
        result_free(r);
    }
    /* rNPU_ip_change */
    {
        ...
        check_param_env("address", "192.168.1.100");
        check_param_env("netmask", "255.255.255.0");
        result_free(r);
        r = dispatch_route("rNPU_ip_change", "clean", &p);
        CK(r && r->code == 0);
        result_free(r);
    }
    /* rNPU_gw_change */
    {
        ...
        check_param_env("gateway", "192.168.1.1");
        result_free(r);
        r = dispatch_route("rNPU_gw_change", "clean", &p);
        CK(r && r->code == 0);
        result_free(r);
    }
    /* rNPU_netdetect_change */
    {
        ...
        result_free(r);
        r = dispatch_route("rNPU_netdetect_change", "clean", &p);
        CK(r && r->code == 0);
        result_free(r);
    }
    /* rNPU_arp_poison */
    {
        ...
        check_param_env("mac", "aa:bb:cc:dd:ee:ff");
        result_free(r);
        r = dispatch_route("rNPU_arp_poison", "clean", &p);
        CK(r && r->code == 0);
        result_free(r);
    }
    /* rNPU_arp_del */
    {
        ...
        result_free(r);
        r = dispatch_route("rNPU_arp_del", "clean", &p);
        CK(r && r->code == 0);
        result_free(r);
    }
    /* rNPU_route_add */
    {
        ...
        result_free(r);
        r = dispatch_route("rNPU_route_add", "clean", &p);
        CK(r && r->code == 0);
        result_free(r);
    }
    /* rNPU_route_del */
    {
        ...
        result_free(r);
        r = dispatch_route("rNPU_route_del", "clean", &p);
        CK(r && r->code == 0);
        result_free(r);
    }
    /* rNPU_iprule_add */
    {
        ...
        check_param_env("dir", "in");
        check_param_env("table", "100");
        result_free(r);
        r = dispatch_route("rNPU_iprule_add", "clean", &p);
        CK(r && r->code == 0);
        result_free(r);
    }
    /* rNPU_iprule_del */
    {
        ...
        result_free(r);
        r = dispatch_route("rNPU_iprule_del", "clean", &p);
        CK(r && r->code == 0);
        result_free(r);
    }
    /* rNPU_iproute_add (6 params) */
    {
        ...
        check_param_env("ip_mask", "255.0.0.0");
        check_param_env("via", "192.168.1.1");
        check_param_env("dev", "eth0");
        check_param_env("table", "100");
        result_free(r);
        r = dispatch_route("rNPU_iproute_add", "clean", &p);
        CK(r && r->code == 0);
        result_free(r);
    }
    /* rNPU_iproute_del */
    {
        ...
        result_free(r);
        r = dispatch_route("rNPU_iproute_del", "clean", &p);
        CK(r && r->code == 0);
        result_free(r);
    }
    /* rNPU_bw_limit */
    {
        ...
        check_param_env("bw_limit", "10000");
        result_free(r);
        r = dispatch_route("rNPU_bw_limit", "clean", &p);
        CK(r && r->code == 0);
        result_free(r);
    }
    /* rNPU_mtu_mismatch */
    {
        ...
        check_param_env("size", "1280");
        result_free(r);
        r = dispatch_route("rNPU_mtu_mismatch", "clean", &p);
        CK(r && r->code == 0);
        result_free(r);
    }
    /* rNPU_dscp_tc_change */
    {
        ...
        check_param_env("dscp", "46");
        check_param_env("tc", "5");
        result_free(r);
        r = dispatch_route("rNPU_dscp_tc_change", "clean", &p);
        CK(r && r->code == 0);
        result_free(r);
    }
    /* rNPU_roce_port_change */
    {
        ...
        check_param_env("port", "4791");
        result_free(r);
        r = dispatch_route("rNPU_roce_port_change", "clean", &p);
        CK(r && r->code == 0);
        result_free(r);
    }
