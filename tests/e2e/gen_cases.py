...
def gen():
    ...
    q_case("rDISK_write_overload", "--device=/tmp --workers=2 --size_mb=50", "--device=/tmp", "", "rDISK query <uid> --device=/tmp")
    ...
    add(flow, 1, "plugin", "rSAMPLE_test", "query_active", "none",
        f"{DCAT} query rSAMPLE_test", 0, "", "", 'out_contains:"confirmed":true', "", "plugin query confirmed:true")
