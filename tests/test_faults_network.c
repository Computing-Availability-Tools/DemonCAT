...
int main(void) {
    ...
    /* rNET_delay */
    {
        ...
        check_param_env("delay_ms", "100");
        result_free(r);
        r = dispatch_route("rNET_delay", "clean", &p);
        CK(r && r->code == 0);
    ...
    /* rNET_loss */
    {
        ...
        check_param_env("iface", "eth0");
        check_param_env("loss_pct", "5");
        result_free(r);
        r = dispatch_route("rNET_loss", "clean", &p);
        CK(r && r->code == 0);
        result_free(r);
    }
    /* rNET_reorder */
    {
        ...
        check_param_env("reorder_pct", "30");
        result_free(r);
        r = dispatch_route("rNET_reorder", "clean", &p);
        CK(r && r->code == 0);
        result_free(r);
    }
    /* rNET_down */
    {
        ...
        result_free(r);
        r = dispatch_route("rNET_down", "clean", &p);
        CK(r && r->code == 0);
        result_free(r);
    }
    /* rNET_degrade (optional speed_mbps) */
    {
        ...
        check_param_env("speed_mbps", "10");
        result_free(r);
        r = dispatch_route("rNET_degrade", "clean", &p);
        CK(r && r->code == 0);
        result_free(r);
    }
    /* rNET_port_occupy (optional protocol) */
    {
        ...
        check_param_env("port", "8080");
        check_param_env("protocol", "tcp");
        result_free(r);
    ...
    /* rNET_service_stop */
    {
        ...
        result_free(r);
        r = dispatch_route("rNET_service_stop", "clean", &p);
        CK(r && r->code == 0);
        result_free(r);
    }
    /* rNET_link_flap (optional cycle_sec, count) */
    {
        ...
        check_param_env("cycle_sec", "2");
        check_param_env("count", "5");
        result_free(r);
        r = dispatch_route("rNET_link_flap", "clean", &p);
        CK(r && r->code == 0);
        result_free(r);
    }
    /* rNET_bw_limit */
    {
        ...
        result_free(r);
        r = dispatch_route("rNET_bw_limit", "clean", &p);
        CK(r && r->code == 0);
        result_free(r);
    }
    /* rNET_jitter */
    {
        ...
        check_param_env("jitter_ms", "20");
        result_free(r);
        r = dispatch_route("rNET_jitter", "clean", &p);
        CK(r && r->code == 0);
        result_free(r);
    }
    /* rNET_tcp_loss (optional direction) */
    {
        ...
        check_param_env("port", "443");
        check_param_env("direction", "both");
        result_free(r);
        r = dispatch_route("rNET_tcp_loss", "clean", &p);
        CK(r && r->code == 0);
        result_free(r);
    }
