...
OBS = {
    ...
    "rNPU_arp_poison": dict(module="npu", inject_args="--chip=2 --dev=eth0 --ip=10.30.12.200 --mac=00:11:22:33:44:55",
    ...
    "rNPU_arp_del": dict(module="npu", inject_args="--chip=2 --dev=eth0 --ip=10.30.12.200",
        clean_args="--chip=2 --dev=eth0 --ip=10.30.12.200", provision="none", precondition="hccn_tool",
    ...
    "rNPU_iproute_add": dict(module="npu", inject_args="--chip=2 --ip=10.30.50.0 --ip_mask=24 --via=10.30.12.254 --dev=eth0 --table=100",
    ...
    "rNPU_iproute_del": dict(module="npu", inject_args="--chip=2 --ip=10.30.51.0 --ip_mask=24 --table=100",
        ...
        setup_cmd=f"{DCAT} inject rNPU_iproute_add --chip=2 --ip=10.30.51.0 --ip_mask=24 --via=10.30.12.254 --dev=eth0 --table=100",
